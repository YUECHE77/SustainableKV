...
def llama_flash_attn2_forward(
    ...
    **kwargs,
    ...
    # [SustainableKV] Initialize the cache_killer
    ...
    if past_key_value is not None:
        ...
        # [SustainableKV] Add kv_seq_len in prepare_inputs_for_generation_llama()
...
def prepare_inputs_for_generation_llama(
    ...
    # [SustainableKV] Omit tokens covered by past_key_values
