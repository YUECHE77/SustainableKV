...
from snapkv.monkeypatch.monkeypatch import replace_mistral, replace_llama, replace_mixtral
...
from Hybridkv.monkeypatch import hybridkv_replace_mistral, hybridkv_replace_llama, hybridkv_replace_mixtral

from fastchat.model import load_model, get_conversation_template

method = 'None'  # SustainableKV or SnapKV or HybridKV or None
assert method in ('SustainableKV', 'SnapKV', 'HybridKV', 'None'), (
...
if method == 'SnapKV':
    ...
    hybridkv_replace_llama()
    hybridkv_replace_mistral()
    hybridkv_replace_mixtral()
else:
